...
def reduce_abssum(
    ...
    *args,
    ...
    """Perform an absolute-value sum reduction on the current Ascend fast-path."""
    parsed_clear, parsed_real_shape = _parse_reduce_optional_args("reduce_abssum", args, clear=clear, real_shape=real_shape)
    legalized_dim = _legalize_reduce_dim(_get_buffer_extent(buffer), dim)
    return _reduce_with_clear(
        buffer,
        out,
...
def reduce_absmax(
    ...
    *args,
    ...
    """Perform an absolute-value max reduction on the current Ascend fast-path."""
    parsed_clear, parsed_real_shape = _parse_reduce_optional_args("reduce_absmax", args, clear=clear, real_shape=real_shape)
    legalized_dim = _legalize_reduce_dim(_get_buffer_extent(buffer), dim)
    return _reduce_with_clear(
        buffer,
        out,
